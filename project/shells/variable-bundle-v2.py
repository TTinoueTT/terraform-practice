...
print("*****************************************")
print("main.tf で使用されている変数の中で、モジュールの変数定義があるものを収集")
print("*****************************************")
variables_to_add = {}
...
print("*****************************************")
print ("bundle_variable.tf に既存の変数名を取得")
print("*****************************************")
existing_vars = set()
try:
...
# 収集した変数定義を表示
print("*****************************************")
print("bundle_variable.tf に追加する変数定義:")
print("*****************************************")
